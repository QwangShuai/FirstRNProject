...
export const styles = StyleSheet.create({
    ...
    OrderBtn:{
        lineHeight:UtilScreen.getHeight(88),
        marginLeft:UtilScreen.getHeight(25),
        marginRight:UtilScreen.getHeight(25),
        backgroundColor:'#ff9d00',
        color:'white',
        textAlign:'center',
        fontSize:15,
    ...
    order_content: {
        width: '100%',
        backgroundColor: '#ffffff',
        height: UtilScreen.getHeight(436),
        position: 'absolute',
        bottom: 0,
    },
    order_title: {
        ...
        color: '#333333',
        alignSelf: 'center',
        lineHeight: UtilScreen.getHeight(112),
    },
    order_clossImage: {
        position: 'absolute',
    ...
    order_itemView: {
        height: UtilScreen.getHeight(97),
        flexDirection: 'row',
    },
    order_imageView: {
    ...
    order_itemText: {
        ...
        fontSize: 15,
        alignSelf: 'center',
        marginLeft: UtilScreen.getWidth(14),
    },
    order_recommend: {
        height:UtilScreen.getHeight(22),
