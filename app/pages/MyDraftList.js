...
import SlideDeleteEditListItem from '../components/SlideDeleteEditListItem';
import ToolBar from '../components/ToolBar';

export default class MyDraftList extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            items: [
                ...
                {key: 7, title: '上海上海0321', imagePath: require('../res/images/shanghai.jpg'), date: '2018-03-11 12:30:56'},
            ]
        };
    }
    ...
    render() {
        return (
            <View style={styles.container}>
                <ToolBar title={'我的草稿'} isShowBack={true}/>
                <FlatList
                    style={{flex: 1}}
                    ...
                    renderItem={({item, index}) => {
                        return (
                            <View>
                            <SlideDeleteEditListItem editCallBack={this.itemEdit.bind(this)}
                ...
                ></FlatList>
                <Text style={styles.button}>新建</Text>
            </View>
        );
    }
}
