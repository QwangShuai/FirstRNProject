            ...
            <View style={{flexDirection:'row',}}>
                ...
                <View style={{marginTop:UtilScreen.getHeight(20),marginLeft:UtilScreen.getWidth(20)}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:UtilScreen.getHeight(22),}}>
                        ...
                        <Text style={styles.textStyle}>{this.props.itemInfo.state}</Text>
                    </View>
                </View>
                <View style={{width:UtilScreen.getWidth(140),marginTop:UtilScreen.getHeight(76),marginLeft:UtilScreen.getWidth(25)}}>
