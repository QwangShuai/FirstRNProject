    ...
    render() {
        return (
            <Modal
                animationType={"slide"}
                transparent={true}
                visible={this.props.isInvite}
                onRequestClose={this.props.clossModal}>
                <View style={Stylecss.styles.order_content}>
                    <Text style={Stylecss.styles.order_title}>选择邀请方式</Text>
                    ...
                    <View style={Stylecss.styles.order_itemView}>
                        ...
                        <Text style={Stylecss.styles.order_itemText}>微信好友</Text>
                    ...
                    <View style={Stylecss.styles.order_light_E5E5E5}/>
                    <View style={Stylecss.styles.order_itemView}>
                        <Image style={Stylecss.styles.order_imageView} source={require('../res/images/friends-r.png')}/>
                        <Text style={Stylecss.styles.order_itemText}>我的好友</Text>
                        <TouchableHighlight
                            style={Stylecss.styles.selectImage}
                    ...
                    <Text style={Stylecss.styles.OrderBtn} onPress={this.props.pay}>邀请</Text>
                </View>
            </Modal>
        )
    }
