...
export default class MyFriendsRememberItem extends Component {
    constructor(props) {
        super(props);
        this.state = {
            images:'',
        ...
        return(
            <View style={{backgroundColor:'#ffffff'}}>
                ...
                <View style={styles.myView}>
                    ...
                    <TouchableHighlight style={{width:UtilScreen.getWidth(186),height:UtilScreen.getHeight(46),position:'absolute',right:0}} onPress={this.props.deleteItem.bind(this,this.props.itemInfo.pfID,this.props.position)}>
