    ...
    render(){
        return(
            <View style={{flex:1,backgroundColor: '#ffffff',flexDirection:'column',}} >
                <ToolBar title={'退款'} isShowBack={true} backClick={this.backClick.bind(this)}/>
                ...
                <View style={{height:UtilScreen.getHeight(98),position:'absolute',bottom:0,flexDirection:'row',width:'100%',borderColor:'#e5e5e5',borderTopWidth:UtilScreen.getHeight(2)}}>
                    ...
                    <Text style={[Styless.styles.travel_textStyle,{alignSelf:'center',position:'absolute',right:UtilScreen.getWidth(40)}]} onPress={this.toEvaluation.bind(this)}>退款中</Text>
                </View>
