...
import KeyboardSpacer from './pickerview/view/KeyboardSpacer';

class MyInputDialog extends BaseDialog {
    ...
    renderContent() {
        return <View style={{ width: this.mScreenWidth, backgroundColor: '#f8f8f8' }}>
            ...
            <View style={{
                width: this.mScreenWidth, height: this.getSize(48), paddingRight: this.getSize(15),marginBottom:this.getSize(50),
